        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="<?php echo getRiskClass($risk_level); ?>">
                        <?php
                            $lower = strtolower($risk_level);
                            if ($lower === 'red') {{
                                echo 'High Risk';
                            }} elseif ($lower === 'green') {{
                                echo 'Low Risk';
                            }} elseif ($lower === 'broken link') {{
                                echo 'Broken Link';
                            }} elseif ($lower === 'not found') {{
                                echo 'Not Found';
                            }} else {{
                                echo htmlspecialchars($risk_level);
                            }}
                        ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php
                            ...
                            $display_location_url = htmlspecialchars($location_url, ENT_QUOTES, 'UTF-8');
                            $short_display_location_url = (strlen($display_location_url) > 80) ? substr($display_location_url, 0, 77) . '...' : $display_location_url;
                            echo "<a href='{{$display_location_url}}' target='_blank' rel='noopener noreferrer' title='{{$display_location_url}}'>{{$short_display_location_url}}</a>";
                        ?>
                    </td>
                </tr>
                <?php endforeach; ?>
